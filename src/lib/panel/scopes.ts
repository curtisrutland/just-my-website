...
/** The kitchen panel device: read everything, write the one thing it's genuinely better at. */
export const KITCHEN_PANEL_SCOPES: PanelScope[] = ["panel:read", "panel:write:shopping"];
