 ...
 *
 * Every mutation calls `bump("health")` AFTER it commits so the panel's version poll notices — the
 * weight card lives on the health screen (panel-contract §4.2). Fire-and-forget; never fails a write.
 * New write paths MUST bump too.
 */
